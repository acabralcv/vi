...
public class SetorController {
    ...
    public String actionView(ModelMap model, @PathVariable UUID id) {
        ...
        //ArrayList<Ala> AlaList = new AlaService(env).findAllBySetor(id);
        ...
        if (request.getMethod().equals("POST")) {
            ...
            if (!result.hasErrors()){
                ...
                if(createdSetor != null)
                    return "redirect:/admin/setores/view/" + createdSetor.getId();
                else
    ...
    public String actionUpdate(@ModelAttribute Ala objSetor, @PathVariable UUID id, BindingResult result,
                               ModelMap model, HttpServletRequest request) {
